...
const QUESTIONS = [
  ...
  { id:"D05-N1-001", cat:"D05", level:"N1",
    ...
    explain:"Il est interdit de stationner à moins de 5 mètres d'une borne d'incendie." },
  ...
  { id:"D07-N3-001", cat:"D07", level:"N3",
    q:"Un conducteur avec un permis régulier a un taux d'alcoolémie entre 0,05 et 0,08. Quelles sont les conséquences ?",
    choices:["Aucune, il est sous la limite légale","Suspension administrative immédiate de 24h du permis","Accusation criminelle","Amende de 300$ seulement"],
    answer:1, ref:"CSR art. 202.3",
    explain:"Entre 0,05 et 0,08, le conducteur fait l'objet d'une suspension immédiate de 24h. Ce n'est pas criminel mais c'est une sanction administrative." },
  { id:"D07-N4-001", cat:"D07", level:"N4",
    q:"Après combien d'heures un adulte de poids moyen élimine-t-il environ une consommation standard d'alcool ?",
    choices:["30 minutes","1 heure","1 heure 30 minutes","2 heures"],
    answer:1, ref:"Guide de la route SAAQ",
    explain:"Le corps élimine environ une consommation standard par heure. Aucun truc (café, douche froide) n'accélère l'élimination.",
  ...
  { id:"D09-N1-001", cat:"D09", level:"N1",
    ...
    answer:1, ref:"CSR art. 329.1",
    explain:"La vitesse maximale est de 30 km/h dans une zone scolaire quand les feux clignotants sont en fonction." },
  ...
  { id:"D12-N4-001", cat:"D12", level:"N4",
    ...
    choices:["Amende doublée seulement","Amende doublée + points d'inaptitude doublés","Amende de 438$ à 3 045$, 10 à 14 points d'inaptitude, saisie immédiate possible du véhicule","Retrait du permis automatique de 30 jours"],
    answer:2, ref:"CSR art. 303.2, 516",
    explain:"Un excès de 40+ km/h entraîne de lourdes amendes, un nombre élevé de points et la saisie possible du véhicule pour 7 jours. Un excès de 50+ km/h est encore plus sévère.",
